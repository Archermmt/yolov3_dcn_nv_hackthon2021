...
if(NOT TensorRT_ROOT)
  set(TensorRT_ROOT $ENV{TENSOR_RT_ROOT_DIR})
endif()
...
if(NOT TensorRT_ARCHIVE)
  foreach(search ${_TensorRT_SEARCHES})
    find_library(TensorRT_ARCHIVE NAMES nvinfer_static ${${search}} PATH_SUFFIXES lib)
  endforeach()
endif()
...
if(NOT TensorRT_PLUGIN_ARCHIVE)
  foreach(search ${_TensorRT_SEARCHES})
    find_library(TensorRT_PLUGIN_ARCHIVE NAMES nvinfer_plugin_static ${${search}} PATH_SUFFIXES lib)
  endforeach()
endif()
...
if(TensorRT_FOUND)
  ...
  if(NOT TensorRT_PLUGIN_LIBRARIES)
    set(TensorRT_PLUGIN_LIBRARIES ${TensorRT_PLUGIN_LIBRARY})
  endif()
